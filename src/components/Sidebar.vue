										...
										<div class="relative mt-1">
											...
											>
												<ListboxOption
													...
													:value="source"
												>
													<li class="px-3 py-1" :class="{ 'bg-propresenter-500 text-gray-200': active }">
									...
									<SwitchGroup>
										<div class="flex justify-between px-2">
											...
											<Switch
												...
												:class="isShowPrivates ? 'bg-red-500' : 'bg-gray-500'"
											>
												<span
								...
								<li v-for="(file, fileId) in category.files" :key="fileId">
									<router-link
										...
										class="
											...
											rounded-sm
											hover:border-l-4 hover:border-propresenter-500 hover:text-gray-800
										...
										"
										exact-active-class="border-l-4 border-propresenter-530 text-gray-900"
										@click="isOpen = false"
									>
